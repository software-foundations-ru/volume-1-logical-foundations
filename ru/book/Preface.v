...
(** * Введение *)
    ...
    (** Создание надежного программного обеспечения - это тяжелая задача, крайне тяжелая. Масштабы и сложность современных систем, число людей, вовлеченных в их создание, а так же диапазон требований, накладываемых на эти системы, позволяет в лучшем случае создавать "более-менее" корректные системы, что довольно далеко от систем, корректных на 100%. В то же время, постоянно увеличивающееся колличество перерабатываемой информации и ее влияние, на каждый аспект в жизни современного общества, значительно усиливает цену от возникновения ошибок и уязвимостей.
