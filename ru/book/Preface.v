...
(** * Обзор *)
    ...
    Computer science ученые и инженеры-программисты ответили на все эти вызовы разработкой множества техник для повышения надежности программ: от рекоммендаций по менеджменту команд разрабочиков (напр. Экстремальное программирование), до философии дизайна библиотек (напр. model-view-controller, publish-subscribe, и т.д.) и языков программирования (напр. объектно-ориентированное программирование, аспектно-ориентированное программирование, функциональное программирование, ...), до математических техник для определения свойств программного обеспечения, и инструментов помогающих их проверить. Серия книг "Основы программного обеспечения" фокусируется как-раз на этих инструментах.

    Этот том серии сплетает воедино три концепции:

    (1) Простые инструменты логики для вынесения точных требований к программам.

    (2) Использование инструментов интерактивного доказательства теорем для построения строгих доказательств.

    (3) Функциональное программирование и в качестве парадигмы программирования, которая делает понятнее рассуждения о программах, и как связующий мост между программированием как инженерной дисциплиной и логикой как наукой. *)

(* ================================================================= *)
(** ** Логика *)

(** Логика - это область, объектом изучения которой являются доказательства - неопровержимые свидетельства истинности каких-либо утверждений.
    Большое колличество книиг было написано о центральной роли логики в Computer Science дисциплинах. Manna и Waldinger называли её "алгебра
    computer science," тогда как Halpern в своей работе "On the Unusual
    Effectiveness of Logic in Computer Science" составил целый список идей в логике, знание и понимание которых развивает интуицию и предоставляет мощнейшие инструменты для пониманиия глубоких идей в программировании. Indeed,
