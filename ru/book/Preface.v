...
(** Здесь начинается серия электронных книг "Основы программного обеспечения", описывающая математический фундамент, необходимый для создания надежных программ. Серия книг рассматривает такие темы как базовые понятия логики, доказательство теорем с помощью компьютера, инструмент интерактивного доказательства теорем Coq, функциональное программирование, логика рассуждений при построении программ,
 статические системы типов, property-based тестирование, и некоторые приемы для доказательства корректности кода на языке C. Предлагаемый материал предназначен для широкой аудитории читателей: от любопытствующих студентов до исследователей и ученых. Для чтения книги не требуется предварительных знаний в логике или практического опыта программирования, однако некоторый опыт в математических дисциплинах определенно будет полезен.

    Принципиальная новизна этой серии книг в том, что она на сто процентов формализована и проверена компьютером: каждый фрагмент текста - это по сути код для Coq. Книги предназначены для чтения совместно с (или прямо в) интерактивной сессией Coq. Весь текст и большинство упражнений придуманы так, что бы c ними можно было работать в Coq.

    Каждая книга представляет собой набор основных глав, охватывающих примерно семестр материала и организованных в форме линейного повествования, плюс некоторое колличество рекоммендуемых к изучению глав, покрывающих дополнительные темы. Предполагается что материал, изложенный во всех основных главах, доступен для понимания и для старшекурсников, и для выпускников.

    Книга которую вы сейчас читаете, называется "Основы логики", и является фундаментом для остальных книг в серии. Она знакомит читателя с базовыми идеями функционального программирования, конструктивной логики и инструмента интерактивного доказательства теорем Coq. *)

(* ################################################################# *)
(** * Обзор *)

    (** Создание надежного программного обеспечения - это тяжелая задача, крайне тяжелая. Масштабы и сложность современных систем, число людей, вовлеченных в их создание, а так же диапазон требований, накладываемых на эти системы, позволяет в лучшем случае создавать "более-менее" корректные системы, что довольно далеко от систем, корректных на 100%%. В то же время, постоянно увеличивающееся колличество перерабатываемой информации и ее влияние на каждый аспект жизни современного общества, значительно увеличивает цену от наличия ошибки или уязвимости.
    Computer Science ученые и инженеры-программисты отвечают на эти вызовы выработкой множества техник для повышения надежности программ: от рекоммендаций по менеджменту команд разрабочиков (напр. методики экстремального программирования), до философии дизайна библиотек (напр. model-view-controller, publish-subscribe, и т.д.) и языков программирования (напр. объектно-ориентированное программирование, аспектно-ориентированное программирование, функциональное программирование, ...), до математических техник для определения свойств программного обеспечения, и инструментов помогающих их проверить. Серия книг "Основы программного обеспечения" фокусируется как-раз на этих инструментах.

    Этот том серии охватывает следующие три темы:

    (1) Основные логические инстрменты, позволяющие для составлять точные требования к программам.

    (2) Использование инструментов интерактивного доказательства теорем для построения строгих доказательств.

    (3) Функциональное программирование, как в качестве парадигмы программирования, которая делает понятнее рассуждения о программах, так и как связующий мост между программированием (как инженерной дисциплиной) и логикой (как наукой). *)

(* ================================================================= *)
(** ** Логика *)

(** Логика - это сфера науки, объектом изучения которой являются доказательства - неопровержимые свидетельства истинности каких-либо утверждений.
    Большое колличество книг было написано о центральной роли логики в Сomputer Science дисциплинах. Manna и Waldinger называли её "алгебра
    computer science," тогда как Halpern в своей работе "On the Unusual
    Effectiveness of Logic in Computer Science" составил обширный список идей из логики, которые могут стать важными инструментами и открытиями для будущего специалиста. Так же он отмечает что "Оказалось, что логика имеет значительно больший эффект в computer science, чем до этого имела в математике. Это весьма примечательно, особенно если учесть тот факт, что последние сто лет логика наиболее активно развивалась как-раз математиками".

    В частности, фундаментальные инструменты индуктивных доказательств
    проникли во все сферы computer science. Вы определенно встречали их раньше, возможно в курсе по дискретной математике или анализу алгоритмов. Однако в этом курсе мы рассмотрим их значительно глубже, чем вы, вероятно, делали до сих пор. *)

(* ================================================================= *)
(** ** Инструменты интерактивного доказательства теорем (Proof Assistants) *)

(** Заимствование идей между логикой и computer sciense не всегда направлено в одну сторону: развитие computer sciense так же произвело значительный вклад в логику.
    Одним из примеров является разработка программных инструментов, которые помогают конструировать доказательства логических высказываний. Существует два основных типа таких инструментов:
