...
(** Заимствование идей между логикой и computer sciense не всегда
 ...
 теорем, находящимся в разработке с 1983-го года. За последние годы
 Coq собрал крупное сообщество пользователей, состоящего как из людей
 занимающихся преимущественно исследовательской деятельностью, так и
 из специалистов промышленной индустрии. Coq представляет собой
 богатую возможностями среду для интерактивной разработки формального
 доказательства и его автоматической проверки машиной. Ядром системы
 Coq, является простой доказыватель теорем, который всегда
 обеспечивает единственно верную последовательность шагов
 вывода. Поверх этого ядра Coq предоставляет удобные высокоуровневые
 возможности для разработки доказательств, включая обширную библиотеку
 распространенных определений и лемм, мощные "тактики" для
 конструирования сложных доказательств в полу-автоматическом режиме, а
 так же специальный язык программирования для определения новых
