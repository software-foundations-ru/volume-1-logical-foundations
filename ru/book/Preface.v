...
(** Здесь начинается серия электронных книг "Основы программного обеспечения", описывающая математический фундамент, необходимый для создания надежных программ. Серия книг рассматривает такие темы как: базовые понятия логики, доказательство теорем с помощью компьютера, программа-помощник для доказательства теорем Coq, функциональное программирование, логика рассуждений при построении программ,
    ...
    Книга которую вы сейчас читаете, называется "Основы логики", и является фундаментом для остальных книг в серии. Она знакомит читателя с базовыми идеями функционального программирования, конструктивной логики и программой-помощником для доказательства теорем Coq. *)
