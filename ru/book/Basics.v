...
(** Функциональный стиль программирования основан на простой
    ...
    функции в качестве значений первого порядка (first-class values),
    т.е. значения которые можно передавать другим функциям в качестве
    их аргументов, возвращать как результат выполнения функции, делать
    её частью какой-либо структуры данных, и т.д. Наличие возможности
...
(** Одной из интересных особенностей Coq является то, что множество
